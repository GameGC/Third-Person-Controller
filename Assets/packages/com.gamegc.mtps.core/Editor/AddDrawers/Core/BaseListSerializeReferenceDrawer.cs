...
namespace MTPS.Core.Editor.AddDrawers.Core
{
    ...
    public class BaseListSerializeReferenceDrawer
    {
        ...
        static BaseListSerializeReferenceDrawer()
        {
            ...
            GetAttributesForFieldF = property =>
            {
                Type t = null;
        ...
        private bool HasAddButtonAttribute(Type t)
        {
            ...
            foreach (var fieldInfo in fields)
            {
                ...
                if(fieldInfo.FieldType.IsSubclassOf(typeof(Object))) continue;
            ...
            {
                if(propertyInfo.PropertyType.IsSubclassOf(typeof(Object))) continue;
        ...
        private void InjectListFooter(SerializedProperty property, IAddButtonAttribute attribute)
        {
            ...
            {
                element = new ReorderableListWrapperRef(property,EditorGUIUtility.TrTextContent(property.displayName));
