...
namespace ThirdPersonController.Core.StateMachine
{
    ...
    [SerializeField] private
            ...
            State[] states = 
            {
                ...
                {
                    Name = "Move",
                    features = new BaseFeature[]{ new MoveFeature(), new JumpFeature()  }
                },
                new State()
                {
                    Name = "Sprint",
                    features = new BaseFeature[]{ new SprintFeature(),new JumpFeature()  }
                },
                new State()
                {
                    Name = "Crouch",
                    features = new []{ new CrouchFeature(),  }
                },
                new State()
                {
                    Name = "Air",
                    features = new []{ new AirFeature(),  }
                },
            };
